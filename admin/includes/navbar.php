<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-lg"><img src="images/logo2.png" alt="..." href="index.php" style="width: 174px;" /></span>
  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top" style="padding-top: 8px; padding-bottom: 8px;">
